  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        {query && (
          <p className="text-gray-600 mt-1 dark:text-gray-400">Results for "{query}"</p>
        )}
      </div>
      ...
      <Card>
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2 dark:text-white">Search Page</h3>
