      ...
      {isLoading ? (
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar">
          {Object.entries(groupedChanges).map(([date, dateChanges]) => (
            <div key={date} className="border-b border-gray-100 last:border-b-0 dark:border-gray-800">
              <div className="sticky top-0 bg-gray-50 px-4 py-2 border-b border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                <h4 className="text-xs font-semibold text-gray-700 uppercase tracking-wide dark:text-gray-300">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="space-y-2">
                        ...
                        {change.change_type === 'insert' && (
                          <div className="text-xs">
                            <span className="font-medium text-gray-600 dark:text-gray-400">Initial value:</span>
                            <div className="mt-1 p-2 bg-green-50 border border-green-200 rounded text-green-800">
                              {formatValue(change.new_value, change.field_name)}
                            </div>
                          </div>
