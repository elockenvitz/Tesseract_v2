      ...
      {showAssignModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg sm:max-w-xl md:max-w-2xl lg:max-w-3xl max-h-[85vh] sm:max-h-[90vh] flex flex-col dark:bg-gray-800">
            ...
            {assignments && assignments.length > 0 && (
              <div className="flex-shrink-0 px-4 sm:px-6 py-3 sm:py-4 bg-gray-50 border-b border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                <div className="text-xs font-semibold text-gray-700 mb-2 uppercase tracking-wide dark:text-gray-300">
                  Currently Assigned
                </div>
            ...
            <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-5 space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm dark:border-gray-600"
                    autoFocus
                  />
                </div>

                {/* User list */}
                <div className="mt-3 max-h-60 overflow-y-auto border border-gray-200 rounded-lg divide-y divide-gray-100 dark:border-gray-700 dark:divide-gray-800">
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              <p className="text-sm font-medium text-gray-900 truncate dark:text-white">{getUserName(user)}</p>
                              {user.first_name && user.last_name && (
                                <p className="text-xs text-gray-500 truncate mt-0.5 dark:text-gray-400">{user.email}</p>
                              )}
                            </div>
                          </div>
                        </button>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none text-sm dark:border-gray-600"
                  rows={4}
                />
              </div>
            </div>
            ...
            <div className="sticky bottom-0 bg-gray-50 border-t border-gray-200 px-4 sm:px-6 py-3 sm:py-4 rounded-b-xl flex flex-col sm:flex-row gap-2 sm:gap-3 dark:border-gray-700 dark:bg-gray-900">
              <Button
                variant="outline"
                onClick={() => {
                  setShowAssignModal(false)
