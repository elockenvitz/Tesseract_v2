  ...
  return (
    <div className={`relative ${className}`}>
      <button
        ...
        className="flex items-center space-x-3 px-4 py-2.5 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 hover:shadow-sm transition-all duration-200 min-w-[140px] dark:hover:bg-gray-800 dark:border-gray-700 dark:bg-gray-800"
      >
        <div className={`w-4 h-4 rounded-full ${currentStageData.color} shadow-sm`}></div>
        <span className="text-sm font-semibold text-gray-800 dark:text-gray-100">{currentStageData.label}</span>
      ...
      {isOpen && (
        <>
          ...
          {/* Dropdown */}
          <div className="absolute top-full right-0 mt-2 w-56 bg-white border border-gray-200 rounded-xl shadow-xl z-20 overflow-hidden transform-gpu dark:border-gray-700 dark:bg-gray-800">
            <div className="py-2">
              <div className="px-3 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider border-b border-gray-100 dark:border-gray-800 dark:text-gray-400">
                Research Stage
              </div>
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex flex-col">
                      <span className={`text-sm font-semibold ${stage.id === currentStage ? 'text-blue-900' : 'text-gray-800 dark:text-gray-100'}`}>
                        {stage.label}
                      </span>
