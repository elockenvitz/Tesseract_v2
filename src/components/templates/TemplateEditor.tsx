...
export function TemplateEditor({
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-gray-800">
      ...
      <div className="flex items-center gap-2 px-4 py-2 border-b border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-900">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-28 pl-7 pr-2 py-1.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:border-gray-600"
          />
        </div>
        ...
        <select
          ...
          className="px-2 py-1.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent bg-white dark:border-gray-600 dark:bg-gray-800"
        >
          {CATEGORIES.map(cat => (
        ...
        <div className="flex rounded-lg border border-gray-300 overflow-hidden dark:border-gray-600">
          ...
          <button
            ...
            className={clsx(
              'px-3 py-1.5 text-sm font-medium flex items-center gap-1.5 transition-colors border-l border-gray-300 dark:border-gray-600',
              mode === 'preview'
                ? 'bg-primary-600 text-white'
                : 'bg-white text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 dark:text-gray-400 dark:bg-gray-800'
            )}
        ...
        <button
          ...
          className={clsx(
            ...
            showSettings ? 'bg-primary-100 text-primary-700' : 'text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-gray-400'
          )}
      ...
      {showSettings && (
        <div className="px-4 py-2 border-b border-gray-200 bg-gray-50 flex items-center gap-4 dark:border-gray-700 dark:bg-gray-900">
          {/* Tags */}
          <div className="flex items-center gap-2">
            ...
            {formData.tag_ids.length === 0 ? (
              <button
                ...
                className="px-2 py-1 text-xs text-gray-500 hover:text-primary-600 border border-dashed border-gray-300 rounded-lg flex items-center gap-1 dark:border-gray-600 dark:text-gray-400"
              >
              ...
              <div className="flex items-center gap-1">
                ...
                {formData.tag_ids.length > 3 && (
                  <span className="text-xs text-gray-500 dark:text-gray-400">+{formData.tag_ids.length - 3}</span>
                )}
                <button
                  type="button"
                  onClick={() => setShowTagPicker(true)}
                  className="px-1.5 py-0.5 text-xs text-gray-500 hover:text-primary-600 dark:text-gray-400"
                >
                  Edit
                </button>
              </div>
          ...
          <div className="flex-1">
            <input
              ...
              className="w-full px-2 py-1 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:border-gray-600"
            />
          </div>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="flex-1 flex flex-col overflow-hidden">
        <div className="flex-1 overflow-hidden relative">
          {mode === 'edit' ? (
            ...
            <div className="h-full flex flex-col">
              ...
              <div className="px-4 py-1.5 bg-gray-50 border-b border-gray-100 text-xs text-gray-500 flex items-center justify-between dark:border-gray-800 dark:text-gray-400 dark:bg-gray-900">
              ...
              {showVariables && variables.length > 0 && (
                <div className="px-4 py-2 bg-gray-50 border-b border-gray-200 text-xs dark:border-gray-700 dark:bg-gray-900">
                  {/* Validation warnings */}
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    {standardVars.length > 0 && (
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-gray-500 dark:text-gray-400">Fill-in:</span>
            ...
            <div className="h-full flex flex-col bg-gray-50 dark:bg-gray-900">
              <div className="flex-1 overflow-auto p-6">
                <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-sm border border-gray-200 p-6 dark:border-gray-700 dark:bg-gray-800">
                  {/* Template Name */}
                  <div className="mb-4 pb-4 border-b border-gray-100 dark:border-gray-800">
                    ...
                    <div className="flex items-center gap-3 mt-2 text-sm text-gray-500 dark:text-gray-400">
                      <span className="px-2 py-0.5 bg-gray-100 rounded dark:bg-gray-800">{getCategoryLabel(formData.category)}</span>
                      {formData.shortcut && (
        ...
        {/* Footer Actions */}
        <div className="px-4 py-2 border-t border-gray-200 bg-gray-50 flex items-center justify-between dark:border-gray-700 dark:bg-gray-900">
          <div className="flex items-center gap-2">
            {template && onShare && (
