...
import { X, Plus, TrendingUp, Briefcase, Tag, FileText, Home, File, List, User, Users, Settings, Lightbulb, Workflow, ChevronLeft, ChevronRight, Repeat, FolderKanban, ListTodo, Beaker, BookOpen, Clock, PieChart, Calendar, Building2, Target, FolderOpen, LineChart, ChevronDown, Check, Activity, Flag, Sun, Microscope, Scale } from 'lucide-react'
...
export interface Tab {
  ...
  | 'calendar' | 'priorities' | 'today' | 'ideas-v2' | 'research-v2' | 'portfolio-v2' | 'coverage' | 'organization' | 'outcomes' | 'files' | 'charting' | 'audit'
  data?: any
  isActive: boolean
  isBlank?: boolean
}
...
const SINGLETON_TYPES = new Set([
  ...
  'priorities', 'today', 'ideas-v2', 'research-v2', 'portfolio-v2', 'coverage', 'organization', 'outcomes', 'files', 'charting', 'audit'
])
