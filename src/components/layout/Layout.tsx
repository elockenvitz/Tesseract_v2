...
const FULL_WIDTH_TAB_TYPES = ['trade-lab', 'trade-queue', 'trade-book', 'coverage', 'organization', 'templates', 'dashboard', 'audit', 'lists', 'idea-generator', 'today', 'ideas', 'ideas-v2', 'research-v2', 'portfolio-v2', 'decisions-v2']
