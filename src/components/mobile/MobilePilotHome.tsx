 ...
 *
 * ── Setup comes first, then gets out of the way ───────────────────────────
 *
 ...
 * mission appears and the card becomes one line. `usePilotEntry` decides
 * which; it is a sequence, not a sixth step, and nothing about graduation
 * changes.
 *
