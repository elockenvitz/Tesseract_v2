  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <span className="text-sm text-gray-900 truncate block dark:text-white">{doc.title}</span>
      </div>
...
export function KeyReferencesSection({
        ...
        <div className="bg-violet-50/50 rounded-lg border border-violet-100 px-3 py-2 text-xs space-y-1.5">
          {meta.generated_by_name && (
            <div className="flex items-center gap-1.5 text-gray-600 dark:text-gray-400">
              ...
              <span>Generated by <span className="font-medium text-gray-800 dark:text-gray-100">{meta.generated_by_name}</span></span>
            </div>
          )}
          {meta.as_of_date && (
            <div className="flex items-center gap-1.5 text-gray-600 dark:text-gray-400">
          ...
          {meta.template_name && (
            <div className="flex items-center gap-1.5 text-gray-600 dark:text-gray-400">
              ...
              <span>Template: <span className="font-medium text-gray-800 dark:text-gray-100">{meta.template_name}</span></span>
            </div>
          )}
  ...
  const renderContent = () => (
    <div
      ref={dropZoneRef}
      className={clsx(
        isEmbedded ? '' : 'border-t border-gray-100 px-6 py-4 dark:border-gray-800',
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-3">
        ...
        <div className="relative">
          ...
          {showFilterDropdown && (
            <>
              ...
              <div className="absolute left-0 mt-1 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-20 dark:border-gray-700 dark:bg-gray-800">
                {/* Main filters */}
                {FILTER_OPTIONS.filter(o => o.group === 'main').map(opt => {
                  ...
                  return (
                    <button
                      ...
                      className={clsx(
                        'w-full px-3 py-1.5 text-sm text-left flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-800',
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-1.5 text-sm border border-gray-200 rounded-md focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:border-gray-700"
          />
        </div>
                ...
                {onCreateNote && (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500 dark:text-gray-400">Create a new research note</div>
                    </div>
                  </button>
                )}
      ...
      {isLoading ? (
        ...
        <div
          className="text-center py-8 bg-gray-50 rounded-lg border border-dashed border-gray-200 cursor-pointer hover:border-primary-300 hover:bg-primary-50/30 transition-colors dark:border-gray-700 dark:bg-gray-900"
          onClick={() => fileInputRef.current?.click()}
        >
          <Upload className="h-8 w-8 text-gray-400 mx-auto mb-2" />
          <p className="text-sm text-gray-600 font-medium mb-1 dark:text-gray-400">
            {allDocs.length === 0
              ? 'No documents yet'
    ...
    <>
      <Card padding="none">
        ...
        >
          ...
          <span className="font-medium text-gray-900 dark:text-white">Asset Library</span>
