...
export function KeyboardHelpModal({ isOpen, onClose }: KeyboardHelpModalProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-viewport-80 overflow-hidden animate-in fade-in zoom-in-95 duration-200 dark:bg-gray-800">
        {/* Header */}
