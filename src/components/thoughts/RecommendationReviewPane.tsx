 ...
 * is selected from the recommendation list. Shows idea summary, existing
 * recommendations, and an inline form to create/update the current user's recommendation.
 */
...
import { InlineRecommendationForm } from './InlineRecommendationForm'
import type { TradeQueueItemWithDetails, TradeProposalWithUser } from '../../types/trading'

interface RecommendationReviewPaneProps {
...
export function RecommendationReviewPane({ tradeIdea, onBack, onClose }: RecommendationReviewPaneProps) {
  const { user } = useAuth()
          ...
          <div className="bg-gray-50 dark:bg-gray-800/60 rounded-lg p-2.5 space-y-1.5">
            ...
            {tradeIdea.proposed_weight != null && (
              <div className="text-[11px] text-gray-500 dark:text-gray-400">
                Recommended: {tradeIdea.proposed_weight}%
          ...
          {isLoading ? (
            ...
            <div className="py-4 text-center">
              ...
              <p className="text-xs text-gray-400 dark:text-gray-500">
                No recommendations yet. Be the first to weigh in.
              </p>
            </div>
          ) : (
        ...
        <section>
          {showForm ? (
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 text-center py-2">
              No portfolio linked — recommendations require a portfolio context.
            </p>
          )}
        </section>
      </div>
