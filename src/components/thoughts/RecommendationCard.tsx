 ...
 * RecommendationCard
 *
 * Presentational component for a single recommendation in the review pane list.
...
export function RecommendationCard({ proposal, isCurrentUser, isExpanded, onToggleExpand }: RecommendationCardProps) {
