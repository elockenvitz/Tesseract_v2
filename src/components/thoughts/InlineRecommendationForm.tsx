 ...
 *
 * Compact inline form for creating or editing a recommendation within the right pane.
...
export function InlineRecommendationForm({
  tradeIdea,
  existingProposal,
  portfolioId,
  onSaved,
  ...
  const saveMutation = useMutation({
    mutationFn: async () => {
      ...
      if (directionConflict !== null) {
        throw new Error('Cannot save recommendation with direction conflict.')
      }
    ...
    onSuccess: () => {
      success(existingProposal ? 'Recommendation updated' : 'Recommendation submitted')
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-2">
        ...
        >
          {saveMutation.isPending ? 'Saving...' : existingProposal ? 'Update' : 'Submit Recommendation'}
        </button>
        <button
          type="button"
          onClick={onCancel}
