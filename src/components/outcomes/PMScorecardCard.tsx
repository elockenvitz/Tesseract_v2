...
function getTier(hitRate: number | null): { label: string; color: string; bgColor: string } {
  if (hitRate === null) return { label: 'N/A', color: 'text-gray-500 dark:text-gray-400', bgColor: 'bg-gray-100 dark:bg-gray-800' }
...
function MetricRow({ label, value, subtext, icon: Icon, iconColor }: {
  ...
  return (
    <div className="flex items-center gap-3 py-2">
      <div className={clsx('p-2 rounded-lg bg-gray-50 dark:bg-gray-900', iconColor || 'text-gray-400')}>
    ...
    return (
      <div className={clsx('bg-white rounded-lg border border-gray-200 p-5 dark:border-gray-700 dark:bg-gray-800', className)}>
        <div className="text-center py-6">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">No PM performance data</p>
      ...
      <div className={clsx('bg-white rounded-lg border border-gray-200 p-4 dark:border-gray-700 dark:bg-gray-800', className)}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-medium text-gray-900 dark:text-white">{scorecard.userName}</div>
          ...
          <div className="flex items-center gap-3 text-[11px]">
            <div className="text-center">
              <div className="font-semibold text-gray-900 dark:text-white">{scorecard.executionRate?.toFixed(0) || '—'}%</div>
              <div className="text-gray-400">Exec Rate</div>
            </div>
            {scorecard.directionalHitRate != null && (
              <div className="text-center">
                <div className="font-semibold text-gray-900 dark:text-white">{scorecard.directionalHitRate.toFixed(0)}%</div>
                <div className="text-gray-400">Hit Rate</div>
              </div>
            )}
            {scorecard.avgExecutionLagDays != null && (
              <div className="text-center">
                <div className="font-semibold text-gray-900 dark:text-white">{scorecard.avgExecutionLagDays.toFixed(1)}d</div>
      ...
      <div className="p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Briefcase className="w-5 h-5 text-violet-500" />
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white">{scorecard.userName}</h3>
      ...
      <div className="p-5 space-y-4">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
            ...
            <div className="p-3 bg-green-50 rounded-lg text-center">
              ...
              <div className="text-[10px] text-gray-500 dark:text-gray-400">Executed</div>
            </div>
          ...
          {scorecard.executionRate != null && (
            <div className="mt-2">
              <div className="flex items-center justify-between mb-1">
                <span className="text-[11px] text-gray-500 dark:text-gray-400">Execution Rate</span>
                <span className="text-[11px] font-semibold text-gray-900 dark:text-white">{scorecard.executionRate.toFixed(0)}%</span>
              </div>
        ...
        <div>
          ...
          {scorecard.directionalHitRate != null && (
            <div>
              <div className="flex items-center justify-between mb-1">
                <span className="text-[11px] text-gray-500 dark:text-gray-400">Directional Hit Rate</span>
