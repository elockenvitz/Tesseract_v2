    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center dark:bg-gray-900">
        <div className="text-center">
          ...
          <h1 className="text-lg font-semibold text-gray-800 dark:text-gray-100">Access Restricted</h1>
          <p className="text-sm text-gray-500 mt-1 dark:text-gray-400">The Operations Portal is available to Tesseract platform staff only.</p>
